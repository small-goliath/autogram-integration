import SnsRaiseAIComment from '@/components/sns-raise-ai-comment';
import { Metadata } from 'next';

export const metadata: Metadata = {
  title: '[AI] 자동 댓글 받기 신청',
  description: 'AI를 통해 주기적으로 신규 피드에 댓글과 좋아요를 받을 수 있습니다.',
};

export default function SnsRaiseAICommentPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-center mb-8">AI 자동 댓글 받기 신청</h1>
      <div className="bg-card p-6 rounded-lg shadow-md mb-8">
        ...
        <p className="text-muted-foreground mb-4">
          ...
          이를 통해 계정의 활동성을 높이고, 더 많은 사용자에게 노출될 기회를 얻을 수 있습니다.
        </p>
